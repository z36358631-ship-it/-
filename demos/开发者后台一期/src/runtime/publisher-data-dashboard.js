...
(function registerPublisherDataDashboard(namespace) {
  ...
  const renderOverview = (state, language) => {
    ...
    return `<div class="publisher-dashboard-metrics">
      ...
      ${metricCard(text('待结算','Pending settlement',language),pendingText(m),text('按结算币种展示，不作经营分摊','Shown by settlement currency; not allocated by analytics',language),'pending')}
