...
(function registerPublisherDataDashboard(namespace) {
  ...
  const orders = Object.freeze([
    { id:'RCN-202609-A8F2K7', orderMask:'ORD-****-1842', date:'2026-09-10 18:42', game:'星海远征', gameEn:'Stellar Voyage', sku:'SKU-BASE-001', product:'星海远征', productEn:'Stellar Voyage', productType:'base', fulfillment:'direct', region:'global', country:'日本', countryEn:'Japan', platform:'Mac', channel:'第三方支付', channelEn:'Third-party payment', currency:'CNY', amountMinor:12800, refundMinor:0, chargebackRiskMinor:0, chargebackLossMinor:0, taxMinor:512, channelFeeMinor:384, platformShareMinor:1920, adjustmentMinor:0, settlementMinor:9984, statementId:'ST-202608-001', statementStatus:'locked', paymentStatus:'pending', status:'completed', delivered:true, delivery:'账号权益已生效', deliveryEn:'Account entitlement active' },
    { id:'RCN-202609-C4N8M2', orderMask:'ORD-****-1826', date:'2026-09-10 16:26', game:'星海远征', gameEn:'Stellar Voyage', sku:'SKU-DLC-101', product:'深空回声 DLC', productEn:'Deep Space Echoes DLC', productType:'dlc', fulfillment:'cdkey', region:'global', country:'美国', countryEn:'United States', platform:'Android', channel:'Google Play Billing', channelEn:'Google Play Billing', currency:'CNY', amountMinor:3800, refundMinor:0, chargebackRiskMinor:0, chargebackLossMinor:0, taxMinor:152, channelFeeMinor:114, platformShareMinor:570, adjustmentMinor:0, settlementMinor:2964, statementId:'ST-202608-001', statementStatus:'locked', paymentStatus:'pending', status:'completed', delivered:true, delivery:'CDKEY 已交付', deliveryEn:'CDKEY delivered' },
    { id:'RCN-202609-H7Q3P5', orderMask:'ORD-****-1798', date:'2026-09-10 14:08', game:'像素边境', gameEn:'Pixel Frontier', sku:'SKU-BASE-007', product:'像素边境', productEn:'Pixel Frontier', productType:'base', fulfillment:'direct', region:'global', country:'德国', countryEn:'Germany', platform:'Android', channel:'0 元订单', channelEn:'Zero-price order', currency:'CNY', amountMinor:0, refundMinor:0, chargebackRiskMinor:0, chargebackLossMinor:0, taxMinor:0, channelFeeMinor:0, platformShareMinor:0, adjustmentMinor:0, settlementMinor:0, statementId:'', statementStatus:'none', paymentStatus:'none', status:'free', delivered:true, delivery:'账号权益已生效', deliveryEn:'Account entitlement active' },
    { id:'RCN-202609-Q8F4D1', orderMask:'ORD-****-1715', date:'2026-09-09 21:15', game:'星海远征', gameEn:'Stellar Voyage', sku:'SKU-DLC-205', product:'曙光舰队 DLC', productEn:'Dawn Fleet DLC', productType:'dlc', fulfillment:'direct', region:'global', country:'英国', countryEn:'United Kingdom', platform:'Android', channel:'第三方支付', channelEn:'Third-party payment', currency:'CNY', amountMinor:6800, refundMinor:0, chargebackRiskMinor:0, chargebackLossMinor:0, taxMinor:272, channelFeeMinor:204, platformShareMinor:1020, adjustmentMinor:0, settlementMinor:5304, statementId:'ST-202609-001', statementStatus:'confirmed', paymentStatus:'not_ready', status:'refund_pending', delivered:true, delivery:'账号权益已撤销，退款处理中', deliveryEn:'Entitlement revoked; refund processing' },
    { id:'RCN-202609-L5V9R4', orderMask:'ORD-****-1644', date:'2026-09-09 10:44', game:'星海远征', gameEn:'Stellar Voyage', sku:'SKU-BASE-001', product:'星海远征', productEn:'Stellar Voyage', productType:'base', fulfillment:'cdkey', region:'domestic', country:'中国大陆', countryEn:'Mainland China', platform:'Android', channel:'第三方支付', channelEn:'Third-party payment', currency:'CNY', amountMinor:12800, refundMinor:12800, chargebackRiskMinor:0, chargebackLossMinor:0, taxMinor:0, channelFeeMinor:0, platformShareMinor:0, adjustmentMinor:0, settlementMinor:0, statementId:'ST-202608-001', statementStatus:'locked', paymentStatus:'pending', status:'refunded', delivered:true, delivery:'CDKEY 已交付，退款成功', deliveryEn:'CDKEY delivered; refund completed' },
    { id:'RCN-202609-T2D6X8', orderMask:'ORD-****-1603', date:'2026-09-08 19:03', game:'星海远征', gameEn:'Stellar Voyage', sku:'SKU-DLC-101', product:'深空回声 DLC', productEn:'Deep Space Echoes DLC', productType:'dlc', fulfillment:'cdkey', region:'global', country:'加拿大', countryEn:'Canada', platform:'Mac', channel:'第三方支付', channelEn:'Third-party payment', currency:'CNY', amountMinor:2600, refundMinor:0, chargebackRiskMinor:2600, chargebackLossMinor:0, taxMinor:104, channelFeeMinor:78, platformShareMinor:390, adjustmentMinor:0, settlementMinor:2028, statementId:'ST-202608-001', statementStatus:'locked', paymentStatus:'pending', status:'chargeback_open', delivered:true, delivery:'CDKEY 已交付', deliveryEn:'CDKEY delivered' },
    { id:'RCN-202609-V3J7S9', orderMask:'ORD-****-1586', date:'2026-09-08 12:16', game:'像素边境', gameEn:'Pixel Frontier', sku:'SKU-BASE-007', product:'像素边境', productEn:'Pixel Frontier', productType:'base', fulfillment:'direct', region:'global', country:'法国', countryEn:'France', platform:'Mac', channel:'第三方支付', channelEn:'Third-party payment', currency:'CNY', amountMinor:8800, refundMinor:0, chargebackRiskMinor:0, chargebackLossMinor:0, taxMinor:352, channelFeeMinor:264, platformShareMinor:1320, adjustmentMinor:850, settlementMinor:7714, statementId:'ST-202609-001', statementStatus:'confirmed', paymentStatus:'not_ready', status:'chargeback_won', delivered:true, delivery:'账号权益保持有效', deliveryEn:'Account entitlement remains active', userListDeleted:true },
    { id:'RCN-202609-W9B4J3', orderMask:'ORD-****-1522', date:'2026-09-07 15:22', game:'星海远征', gameEn:'Stellar Voyage', sku:'SKU-DLC-101', product:'深空回声 DLC', productEn:'Deep Space Echoes DLC', productType:'dlc', fulfillment:'direct', region:'global', country:'新加坡', countryEn:'Singapore', platform:'Android', channel:'Google Play Billing', channelEn:'Google Play Billing', currency:'CNY', amountMinor:3800, refundMinor:0, chargebackRiskMinor:0, chargebackLossMinor:3800, taxMinor:0, channelFeeMinor:0, platformShareMinor:0, adjustmentMinor:0, settlementMinor:0, statementId:'ST-202608-001', statementStatus:'locked', paymentStatus:'pending', status:'chargeback_lost', delivered:true, delivery:'账号权益已撤销', deliveryEn:'Account entitlement revoked' },
    { id:'RCN-202609-Z6K1E4', orderMask:'ORD-****-1488', date:'2026-09-06 20:48', game:'像素边境', gameEn:'Pixel Frontier', sku:'SKU-DLC-311', product:'机械荒原 DLC', productEn:'Mechanical Wastes DLC', productType:'dlc', fulfillment:'direct', region:'global', country:'韩国', countryEn:'South Korea', platform:'Mac', channel:'第三方支付', channelEn:'Third-party payment', currency:'CNY', amountMinor:5800, refundMinor:0, chargebackRiskMinor:0, chargebackLossMinor:0, taxMinor:0, channelFeeMinor:0, platformShareMinor:0, adjustmentMinor:0, settlementMinor:0, statementId:'', statementStatus:'none', paymentStatus:'none', status:'closed', delivered:false, delivery:'未完成支付，订单已关闭', deliveryEn:'Payment not completed; order closed' },
    { id:'RCN-202608-M6K2S7', orderMask:'ORD-****-9421', date:'2026-08-05 11:27', game:'像素边境', gameEn:'Pixel Frontier', sku:'SKU-BASE-007', product:'像素边境', productEn:'Pixel Frontier', productType:'base', fulfillment:'cdkey', region:'global', country:'澳大利亚', countryEn:'Australia', platform:'Mac', channel:'第三方支付', channelEn:'Third-party payment', currency:'CNY', amountMinor:8800, refundMinor:0, chargebackRiskMinor:0, chargebackLossMinor:0, taxMinor:352, channelFeeMinor:264, platformShareMinor:1320, adjustmentMinor:0, settlementMinor:6864, statementId:'ST-202607-001', statementStatus:'paid', paymentStatus:'completed', status:'completed', delivered:true, delivery:'CDKEY 已交付', deliveryEn:'CDKEY delivered' },
  ]);
  const statements = Object.freeze([
    { id:'ST-202608-001', period:'2026-08', currency:'CNY', amountMinor:14976, outstandingMinor:14976, status:'locked', paymentStatus:'pending', updatedAt:'2026-09-10 09:30' },
    { id:'ST-202607-001', period:'2026-07', currency:'CNY', amountMinor:6864, outstandingMinor:0, status:'paid', paymentStatus:'completed', updatedAt:'2026-08-15 18:20' },
  ]);
  ...
  const money = (minor, currency = 'CNY') => new Intl.NumberFormat('zh-CN', { style:'currency', currency, minimumFractionDigits:2 }).format(Number(minor || 0) / 100);
  ...
  const metrics = rows => {
    ...
    const grossMinor = paidRows.reduce((sum, item) => sum + item.amountMinor, 0);
    const refundMinor = rows.reduce((sum, item) => sum + item.refundMinor, 0);
  ...
  const renderFilters = (state, language) => {
    ...
    return `<section class="publisher-dashboard-filters" aria-label="${text('数据筛选','Data filters',language)}"><div class="publisher-dashboard-filter-grid">
      ...
      ${filterSelect('game',c.game,[['all',all],['星海远征',en ? 'Stellar Voyage' : '星海远征'],['像素边境',en ? 'Pixel Frontier' : '像素边境']],state,language)}
      ${filterSelect('product',c.product,[['all',all],['base',c.base],['dlc',c.dlc]],state,language)}
      ${filterSelect('fulfillment',c.fulfillment,[['all',all],['direct',c.direct],['cdkey','CDKEY']],state,language)}
    ...
    </div><div class="publisher-dashboard-filter-actions"><span>${text('全部筛选使用同一数据快照','All filters use the same data snapshot',language)}</span><button type="button" data-dashboard-action="reset">${c.reset}</button></div></section>`;
  };
  ...
  const renderOverview = (state, language) => {
    ...
    const directCount = rows.filter(item => item.fulfillment === 'direct').length;
    ...
    return `<div class="publisher-dashboard-metrics">
      ...
      ${metricCard(text('退款成功','Refunded',language),`${m.refundCount}`,money(m.refundMinor),'refund')}
      ${metricCard(text('拒付风险','Chargeback risk',language),`${m.chargebackOpen}`,text(`${money(m.chargebackRiskMinor)} 待裁决`,`${money(m.chargebackRiskMinor)} pending`,language),'chargeback')}
      ${metricCard(text('预估收入','Estimated revenue',language),money(m.estimatedMinor),text('最终以结算单为准','Final amount follows statement',language),'estimated')}
      ${metricCard(text('待结算','Pending settlement',language),money(m.pendingMinor),text('已锁定且尚未清偿','Locked and outstanding',language),'pending')}
  ...
  const renderRevenue = (state, language) => {
    ...
    return `<div class="publisher-dashboard-revenue-grid"><section class="publisher-dashboard-card"><header><div><span>${text('动态预估','ESTIMATE',language)}</span><h2>${text('预估收入','Estimated revenue',language)}</h2><p>${text('随退款、拒付和费用更新，不作为正式付款依据。','Updates with refunds, chargebacks and fees; not a payment basis.',language)}</p></div>${tag(text('以结算单为准','Statement is final',language),'warning')}</header><dl class="publisher-dashboard-formula">
      ${line(text('销售额','Gross sales',language),money(m.grossMinor))}${line(text('退款成功','Refunds',language),`− ${money(m.refundMinor)}`,'negative')}${line(text('拒付败诉','Chargeback losses',language),`− ${money(m.chargebackLossMinor)}`,'negative')}${line(text('税费','Taxes',language),`− ${money(m.taxMinor)}`,'negative')}${line(text('渠道费','Provider fees',language),`− ${money(m.channelFeeMinor)}`,'negative')}${line(text('平台分成','Platform share',language),`− ${money(m.platformShareMinor)}`,'negative')}${line(text('调整项','Adjustments',language),`${m.adjustmentMinor >= 0 ? '+' : '−'} ${money(Math.abs(m.adjustmentMinor))}`,m.adjustmentMinor >= 0 ? 'positive' : 'negative')}<div class="is-total"><dt>${text('预估收入','Estimated revenue',language)}</dt><dd>${money(m.estimatedMinor)}</dd></div></dl><div class="publisher-dashboard-risk-note"><span>${text('拒付待裁决风险','Open chargeback risk',language)}</span><strong>${money(m.chargebackRiskMinor)}</strong><small>${text('尚未扣减','Not deducted',language)}</small></div></section>
      <section class="publisher-dashboard-card"><header><div><span>${text('锁定账单','LOCKED STATEMENT',language)}</span><h2>${text('待结算','Pending settlement',language)}</h2><p>${text('只汇总已锁定且尚未清偿的金额。','Only locked and outstanding amounts are included.',language)}</p></div></header><div class="publisher-dashboard-pending"><strong>${money(m.pendingMinor)}</strong><span>${text('当前筛选对应的未清偿金额','Outstanding amount under current filters',language)}</span></div>${locked ? `<dl class="publisher-dashboard-statement"><div><dt>${text('账期','Period',language)}</dt><dd>${locked.period}</dd></div><div><dt>${text('结算单','Statement',language)}</dt><dd>${locked.id}</dd></div><div><dt>${text('付款状态','Payment status',language)}</dt><dd>${text('待付款','Pending payment',language)}</dd></div><div><dt>${text('更新时间','Updated',language)}</dt><dd>${locked.updatedAt}</dd></div></dl>` : ''}<div class="publisher-dashboard-finance-actions"><button type="button" data-dashboard-action="finance-flows">${text('查看对账流水','View reconciliation flows',language)}</button><button type="button" class="is-primary" data-dashboard-action="finance-settlement">${text('前往对账结算','Go to settlement',language)}</button></div></section></div>`;
  };
  ...
  const bind = (root, { state, onChange, onFinance } = {}) => {
    ...
    host.addEventListener('click', event => {
      ...
      else if (action === 'reset') update({ filters:{ ...defaultFilters } });
