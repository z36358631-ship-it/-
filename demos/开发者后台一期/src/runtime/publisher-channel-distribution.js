...
(function registerPublisherChannelDistribution(namespace) {
  ...
  const fixture = Object.freeze({
    ...
    batches: [
      ...
      { id:'BT-20260901-0002', name:'NovaPlay 本体 API', channelId:'CH-240901', skuId:'BASE-GLOBAL', delivery:'api', quantity:100000, validUntil:'', effectiveStart:'2026-09-01T00:00', effectiveEnd:'', enabled:true, deleted:false, supplyState:'active', clientId:'cli_np_base_202609', secretLast4:'7Q4X', lastSuppliedAt:'2026-09-16 14:22', lastUsedAt:'2026-09-16 14:22', apiStats:{ requests:1602, succeeded:1400, failed:202 }, apiCalls:[{ orderId:'NP-****-8826', requestId:'req_****_7412', skuId:'BASE-GLOBAL', result:'success', errorCode:'', calledAt:'2026-09-16 14:22' },{ orderId:'NP-****-8818', requestId:'req_****_7399', skuId:'BASE-GLOBAL', result:'failed', errorCode:'IDEMPOTENCY_CONFLICT', calledAt:'2026-09-16 13:20' }], note:'本体接口供给', createdAt:'2026-09-01 09:10', updatedAt:'2026-09-16 14:22' },
      { id:'BT-20260901-0001', name:'NovaPlay DLC API', channelId:'CH-240901', skuId:'DLC-SEASON-01', delivery:'api', quantity:100000, validUntil:'', effectiveStart:'2026-09-01T00:00', effectiveEnd:'', enabled:true, deleted:false, supplyState:'active', clientId:'cli_np_dlc_202609', secretLast4:'3R8P', lastSuppliedAt:'2026-09-16 14:18', lastUsedAt:'2026-09-16 14:18', apiStats:{ requests:240, succeeded:240, failed:0 }, apiCalls:[], note:'DLC 接口供给', createdAt:'2026-09-01 09:00', updatedAt:'2026-09-16 14:18' },
      { id:'BT-20260818-0001', name:'北美线下 API', channelId:'CH-240903', skuId:'BASE-GLOBAL', delivery:'api', quantity:100000, validUntil:'', effectiveStart:'2026-08-18T00:00', effectiveEnd:'', enabled:true, deleted:false, supplyState:'active', clientId:'cli_na_20260818', secretLast4:'2K8M', lastSuppliedAt:'2026-09-08 18:40', lastUsedAt:'2026-09-08 18:40', apiStats:{ requests:480, succeeded:480, failed:0 }, apiCalls:[], note:'受渠道停用限制', createdAt:'2026-08-18 09:00', updatedAt:'2026-09-08 18:40' },
      { id:'BT-20260915-0005', name:'ArcadeX DLC 待接入', channelId:'CH-240902', skuId:'DLC-SEASON-01', delivery:'api', quantity:100000, validUntil:'', effectiveStart:'2026-09-15T00:00', effectiveEnd:'', enabled:true, deleted:false, supplyState:'pending_credentials', clientId:'', secretLast4:'', lastSuppliedAt:'', lastUsedAt:'', apiStats:{ requests:0, succeeded:0, failed:0 }, apiCalls:[], note:'待生成凭证', createdAt:'2026-09-15 10:00', updatedAt:'2026-09-15 10:00' },
  ...
  const renderSupply = ({ language, state, transientSecret }) => {
    ...
    const batchRows = filteredBatches.map(batch => {
      ...
      return [`<span class="publisher-channel-row-title"><strong>${e(batch.name)}</strong><small>${e(batch.id)}</small></span>`,`<span class="publisher-channel-row-title"><strong>${e(channel?.name || '—')}</strong><small>${e(channel?.id || batch.channelId)}</small></span>`,`<span class="publisher-channel-row-title"><strong>${e(language === 'en' ? product.labelEn : product.label)}</strong><small>${e(product.id)}</small></span>`,e(deliveryLabel(language,batch.delivery)),e(quantityLabel),e(periodLabel(language,batch.effectiveStart,batch.effectiveEnd)),status(meta[0],meta[1]),e(batch.lastSuppliedAt || '—'),renderBatchActions(language,batch,channel)];
    });
