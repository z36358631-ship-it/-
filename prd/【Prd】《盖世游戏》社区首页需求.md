...
|<font color=”#4e73ff”>**官方发布**</font>|（见demo）|- <font color=”#4e73ff”>**新增模块**</font><br>- **功能定位**：支持运营使用官方马甲号，在指定分区的”官方”Tab下发布动态，发布后带”盖世游戏大使”等自定义身份标签，可自动置顶<br>- **发布设置**：<br>    - 发布人头像：支持上传自定义头像<br>    - 发布人昵称：支持自定义（默认”盖世游戏官方”）<br>    - 身份标签名称：支持自定义（默认”盖世游戏大使”）<br>    - 发布到分区：下拉选择目标分区<br>    - 是否置顶：勾选后发布自动置顶到该分区<br>- **动态内容**：标题（必填）+ 正文（必填）+ 配图（选填）+ 关联话题（选填）<br>- **发布预览**：深色背景模拟前端实际展示效果（头像+昵称+身份标签+时间·官方）<br>- **已发布列表**：表格展示所有官方马甲号发布的动态（ID/发布人/标签/标题/分区/置顶状态/发布时间），支持编辑/置顶/取消置顶/删除<br>- **前端展示联动**：通过官方发布的动态，在前端社区的”官方”子Tab下展示，带对应身份标签<br>- **异常处理**：标题或正文为空时拦截发布并提示”请填写标题和正文”//2026.5.26修改|
