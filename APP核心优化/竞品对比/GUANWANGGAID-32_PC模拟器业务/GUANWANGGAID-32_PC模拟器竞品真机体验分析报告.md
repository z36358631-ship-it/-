...
> 测试日期：2026-08-17—2026-08-18、2026-08-20<br>
> 报告版本：V1.2（增加纯新手入口复测与证据图）
...
### 1.3 纯新手入口复测（2026-08-20）

本轮以“完全不了解 PC 模拟器”的用户视角，从三款 App 冷启动后观察第一屏和第一步动作。为避免破坏设备上的既有账号与游戏数据，仅执行强制停止后启动，未清除数据、退出账号、登录新账号或付款。因此，以下结论用于判断**首屏是否能让新手知道下一步做什么**，不等同于卸载重装后的全新账号首开。

| GameHub 首屏 | 233 首屏 | GameNative 首屏 |
|---|---|---|
| ![GameHub 新手首屏](https://cdn.jsdelivr.net/gh/z36358631-ship-it/-@4e786449651971a969fe48a70c16464fa113cf03/public/prd/guanwanggaid-32-pc-emulator/20-novice-gamehub-home.png) | ![233 新手首屏](https://cdn.jsdelivr.net/gh/z36358631-ship-it/-@4e786449651971a969fe48a70c16464fa113cf03/public/prd/guanwanggaid-32-pc-emulator/21-novice-233-home.png) | ![GameNative 新手首屏](https://cdn.jsdelivr.net/gh/z36358631-ship-it/-@4e786449651971a969fe48a70c16464fa113cf03/public/prd/guanwanggaid-32-pc-emulator/22-novice-gamenative-home.png) |

| 产品 | 首屏事实 | 纯新手理解成本 | 可采纳点 / 应规避点 |
|---|---|---|---|
| GameHub | 直接进入内容首页，出现“继续”、推荐游戏、游戏库等已有用户语义；没有说明“我有 PC 游戏文件时该怎么开始”。 | 中高：内容丰富，但默认用户已经有游戏、知道“玩游戏”和“游戏库”的区别。 | **采纳**：保留游戏内容卡片和“继续”复用；首启增加“我有游戏文件 / 我有 Steam 或 Epic / 我还没有游戏”三选一。**规避**：首屏只堆推荐，不给第一步任务。 |
| 233 乐园 | 直接进入 PC 游戏页；“导入 PC 游戏”是最明确的第一动作，同时并列 Steam、Epic、设置。 | 中：入口明确，但搜索框预填已有游戏名，PC 游戏、网游、创作者等栏目较多。 | **采纳**：把“导入 PC 游戏”作为新手主 CTA，并在首次成功后记住选择。**规避**：不要把预填搜索词和密集频道当作新手引导。 |
| GameNative | 首次可见弹出项目介绍/分享/加入 Ko-fi；关闭后直接展示“全部 / Steam”、最近拷入文件、未知条目和“兼容”等技术型信息。 | 高：新手不知道“未知”“兼容”及图标旁的数字代表什么，也不知道从本地文件还是 Steam 开始。 | **采纳**：保留本地文件、Steam、添加游戏等入口的分组。**规避**：不要把捐赠说明、原始兼容指标和技术术语放在第一任务之前。 |

**纯新手结论：** 三款 App 都没有在首屏回答“我是谁、我有什么、我应该先做什么”。233 的“导入 PC 游戏”最接近可执行的新手入口；GameHub 的内容资产最完整，但需要补一层任务导向；GameNative 的透明度更像高级用户工具，不能直接作为大众首启。

**建议首启最小链路：** 判断账号/设备是否已有完成记录 → 未完成时只问来源与游戏经验 → 有本地文件直接进入导入 → 有 Steam/Epic 进入对应绑定 → 没有游戏进入可试玩/推荐 → 成功后记录结果并复用配置；已完成用户不重复采集或引导。
...
| 系统 | Android 15 |
| 分辨率 | 1116 × 2480 |
| ADB 目标 | `192.168.50.154:41855`（2026-08-20 入口复测；历史链路曾使用 `41355`） |
