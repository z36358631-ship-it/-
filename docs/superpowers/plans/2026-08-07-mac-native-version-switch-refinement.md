...
```powershell
node --test tests/mac-native-version-demo.test.mjs --test-name-pattern="热区|详情页包含"
```
...
- [ ] **Step 1: 将 `targetVersion` 统一改名为 `selectedVersion`**
...
Expected: 7 tests PASS，0 FAIL；内联脚本语法测试 PASS。
...
- [ ] **Step 1: 在 `1076×734px` 逻辑画布检查弹窗视觉**
