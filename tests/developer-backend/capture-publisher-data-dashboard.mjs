...
const flowSteps = [
  ...
  ['02-dashboard-overview.png','02 查看曝光转化','默认展示近 30 天漏斗、趋势与来源分析'],
  ['03-dashboard-calendar.png','03 筛选与理解指标','按时间、商品、来源与地区筛选，问号查看定义'],
  ['05-dashboard-users.png','04 查看用户数据','切换查看活跃、新增、留存与平均游戏时长'],
